...
# Object files
OBJS = main.o order/order.o dispenser/dispenser.o
...
main.o: main.c struct.h dispenser/dispenser.h
	$(CC) $(CFLAGS) -c main.c

order/order.o: order/order.c order/order.h struct.h
	$(CC) $(CFLAGS) -c order/order.c -o order/order.o

dispenser/dispenser.o: dispenser/dispenser.c dispenser/dispenser.h struct.h
